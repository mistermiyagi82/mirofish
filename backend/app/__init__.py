...
def create_app(config_class=Config):
    ...
    # Register simulation process cleanup function (ensures all simulation processes are terminated when the server shuts down)
    ...
    # Serve Vue frontend static files (production build)
