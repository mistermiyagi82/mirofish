...
def chat_with_report_agent():
    ...
    Request (JSON):
        {
            "simulation_id": "sim_xxxx",        // required, simulation ID
            "message": "Please explain the trend of public sentiment",    // required, user message
...
def get_report_sections(report_id: str):
    ...
    The frontend can poll this endpoint to get generated section content without waiting for the whole report to complete
...
def check_report_status(simulation_id: str):
    """
    Check whether a simulation has a report and the report's status
...
def get_agent_log(report_id: str):
    """
    Get detailed execution log for the Report Agent

    Retrieve each step of the report generation process in real time, including:
    - Report start, planning start/complete
    - Start, tool calls, LLM responses, and completion for each section
    - Report complete or failed

    Query parameters:
        from_line: Start reading from this line number (optional, default 0, for incremental retrieval)
...
def get_console_log(report_id: str):
    """
    Get the console output log for the Report Agent
