...
class OasisProfileGenerator:
    ...
    Converts entities from the Zep knowledge graph into Agent Profiles needed for OASIS simulation
    ...
    # Group/institutional-type entities (need to generate representative account personas)
    GROUP_ENTITY_TYPES = [
        ...
        for attempt in range(max_attempts):
            try:
                ...
                if finish_reason == 'length':
                    logger.warning(f"LLM output was truncated (attempt {attempt+1}), attempting fix...")
    ...
    def _fix_truncated_json(self, content: str) -> str:
        ...
        # Simple check: if the last character is not a quote, comma, or closing bracket, the string may be truncated
    ...
    def _get_system_prompt(self, is_individual: bool) -> str:
        ...
        base_prompt = "You are an expert in generating social media user profiles. Generate detailed, realistic personas for opinion simulation that closely reflect real-world situations. You must return valid JSON format; all string values must not contain unescaped newline characters."
        return base_prompt
    ...
    def _build_individual_persona_prompt(
        ...
        return f"""Generate a detailed social media user persona for this entity, closely reflecting real-world situations.
...
2. persona: Detailed persona description (2000-word plain text), must include:
   ...
   - Stance and opinions (attitude toward topics, content that may provoke or move this person)
...
"""
    ...
    def _build_group_persona_prompt(
        ...
        return f"""Generate detailed social media account settings for this institutional/group entity, closely reflecting real-world situations.
...
2. persona: Detailed account settings description (2000-word plain text), must include:
...
- The institutional account's communication must be appropriate for its identity"""
    ...
    def generate_profiles_from_entities(
        ...
        def generate_single_profile(idx: int, entity: EntityNode) -> tuple:
            ...
            try:
                ...
                # Output generated persona to console in real time
    ...
    def _normalize_gender(self, gender: Optional[str]) -> str:
        ...
        # Chinese-to-English mapping (keys preserved for handling Chinese input data)
        gender_map = {
            "男": "male",
            "女": "female",
            "机构": "other",
    ...
    def _save_reddit_json(self, profiles: List[OasisAgentProfile], file_path: str):
        ...
        Must include the user_id field, which is the key for matching in OASIS agent_graph.get_agent()!
