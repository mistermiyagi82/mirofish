...
class SimulationIPCClient:
    ...
    def send_interview(
        ...
        Args:
            ...
            platform: Specified platform (optional)
                ...
                - None: In dual-platform simulation, interview both platforms simultaneously; in single-platform, interview that platform
            timeout: Timeout in seconds

        Returns:
            IPCResponse, with result field containing the interview result
        """
        args = {
            "agent_id": agent_id,
            "prompt": prompt
    ...
    def send_batch_interview(
        ...
        Returns:
            IPCResponse, with result field containing all interview results
        """
