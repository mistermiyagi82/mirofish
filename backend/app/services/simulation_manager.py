...
Uses preset scripts + LLM-powered configuration generation
"""
...
class SimulationManager:
    ...
    def prepare_simulation(
        ...
        Args:
            ...
            simulation_requirement: Simulation requirement description (used by LLM to generate configuration)
            document_text: Original document content (used for LLM to understand the background)
            ...
            parallel_profile_count: Number of parallel persona generators, default 3
