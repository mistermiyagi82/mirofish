...
class EdgeInfo:
    ...
    def is_invalid(self) -> bool:
        """Whether the edge has become invalid"""
...
class InsightForgeResult:
    ...
    Contains retrieval results for multiple sub-queries, along with integrated analysis
    """
    query: str
    ...
    def to_text(self) -> str:
        ...
        if self.key_quotes:
            ...
            for quote in self.key_quotes:
                # Clean various types of quotation marks
...
class ZepToolsService:
    ...
    4. interview_agents - In-depth interview (interviews simulated agents, obtains multi-perspective views)
    ...
    def get_node_edges(self, graph_id: str, node_uuid: str) -> List[EdgeInfo]:
        ...
        Retrieves all graph edges and filters those related to the specified node
    ...
    def insight_forge(
        ...
        # Step 3: Extract related entity UUIDs from edges, only get those entities' info (not all nodes)
        entity_uuids = set()
...
Return a JSON-formatted list of sub-questions."""
    ...
    def panorama_search(
        ...
        This tool is suitable for scenarios requiring a complete understanding of events or tracking their evolution.
    ...
    def interview_agents(
        ...
        - Need to obtain real agent responses (not LLM-simulated)
        ...
        INTERVIEW_PROMPT_PREFIX = (
            ...
            "4. Answer each question by its number, starting each answer with 'Question X:' (X is the question number)\n"
        ...
        try:
            ...
            for i, agent_idx in enumerate(selected_indices):
                ...
                # Strategy 2 (supplemental): Long text inside correctly paired Chinese quotation marks 「」
                if not key_quotes:
    ...
    def _select_agents_for_interview(
        ...
        """
        Use the LLM to select agents for interview.
...
3. Select a diverse range of viewpoints (e.g., supporters, opponents, neutral parties, professionals, etc.)
4. Prioritize roles that are directly related to the event
...
Please select up to {max_agents} agents most suitable for the interview and explain your selection rationale."""
        ...
        try:
            ...
            # Retrieve full profile info for selected agents
            selected_agents = []
            valid_indices = []
            ...
            logger.warning(f"LLM agent selection failed, falling back to default: {e}")
...
2. Identify consensus and differences of opinion
