...
if sys.platform == 'win32':
    ...
    # Reconfigure standard output streams to UTF-8 (fixes garbled characters in the Windows console)
    ...
    async def handle_interview(self, command_id: str, agent_id: int, prompt: str, platform: str = None) -> bool:
        ...
        Args:
            ...
            platform: Specified platform (optional)
                ...
                - None/unspecified: Interview on both platforms, return merged result
...
def fetch_new_actions_from_db(
    ...
    Args:
        ...
        last_rowid: Maximum rowid from the last read (using rowid instead of created_at because created_at format differs across platforms)
...
def _enrich_action_context(
    ...
    try:
        ...
        # Create comment: enrich with the commented-on post's information
...
def create_model(config: Dict[str, Any], use_boost: bool = False):
    ...
    If a boost LLM is configured, parallel simulations can use different API providers per platform,
...
async def run_twitter_simulation(
    ...
    Args:
        ...
        max_rounds: Maximum number of simulation rounds (optional, to truncate overly long simulations)
    ...
    # If an agent is not in the config, use the OASIS default name
...
async def main():
    ...
    parser.add_argument(
        ...
        type=int,
        default=None,
        help='Maximum number of simulation rounds (optional, to truncate overly long simulations)'
    )
    parser.add_argument(
        '--no-wait',
        action='store_true',
