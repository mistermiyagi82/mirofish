          ...
          <div v-if="chatTarget === 'report_agent'" class="report-agent-tools-card">
            <div class="tools-card-header">
              ...
              <div class="tools-card-info">
                ...
                <div class="tools-card-subtitle">A fast chat version of the report generation agent. Capable of calling 4 specialized tools with full MiroFish memory.</div>
              </div>
              ...
              <div class="tools-grid">
                ...
                <div class="tool-item tool-blue">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Graph-based breadth-first traversal that reconstructs event propagation paths and captures the full topology of information flow.</div>
                  </div>
                </div>
                <div class="tool-item tool-orange">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">A GraphRAG-based instant query interface with optimized indexing for rapid extraction of specific node attributes and discrete facts.</div>
                  </div>
                </div>
                <div class="tool-item tool-green">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Autonomous interviewer capable of conducting parallel multi-turn conversations with simulated individuals to collect unstructured opinion and psychological state data.</div>
                  </div>
                </div>
              </div>
            </div>
...
const sendToAgent = async (message) => {
  ...
  if (res.success && res.data) {
    // Correct data path: res.data.result.results is a dict object
    // Format: {"twitter_0": {...}, "reddit_0": {...}} or single platform {"reddit_0": {...}}
    const resultData = res.data.result || res.data
    const resultsDict = resultData.results || resultData

    // Convert dict to array, preferring reddit platform response
    let responseContent = null
    const agentId = selectedAgentIndex.value

    if (typeof resultsDict === 'object' && !Array.isArray(resultsDict)) {
      // Prefer reddit reply, fall back to twitter
...
/* Blockquote styles for chat and survey areas */
