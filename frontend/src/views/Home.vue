      ...
      <section class=”hero-section”>
        <div class=”hero-left”>
          ...
          <div class=”hero-desc”>
            ...
            <p class=”slogan-text”>
              Let the future be rehearsed in Agent swarms, let decisions prevail after a hundred battles<span class=”blinking-cursor”>_</span>
            </p>
          </div>
            ...
            <div class="workflow-list">
              ...
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Dual-platform parallel simulation & auto-parsing of prediction requirements & dynamic temporal memory updates</div>
                </div>
              </div>
              <div class="workflow-item">
            ...
            <div class="console-section">
              ...
              <div class="input-wrapper">
                <textarea
                  ...
                  class="code-input"
                  placeholder="// Describe your simulation or prediction requirement in natural language (e.g. If Wuhan University issues an announcement revoking Xiao's disciplinary action, what public opinion trend would it trigger?)"
                  rows="6"
                  :disabled="loading"
                ></textarea>
...
const startSimulation = () => {
  ...
  import('../store/pendingUpload.js').then(({ setPendingUpload }) => {
    ...
    // Navigate immediately to the Process page (using a special marker for a new project)
    router.push({
      name: 'Process',
...
:root {
  ...
  --border: #E5E5E5;
  /*
    Using Space Grotesk as the primary heading font and JetBrains Mono as the code/label font.
