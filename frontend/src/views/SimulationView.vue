...
const checkAndStopRunningSimulation = async () => {
  ...
  try {
    ...
    // Failure to check environment status should not block the rest of the flow
...
onMounted(async () => {
  ...
  // Check and stop any running simulation (triggered when user navigates back from Step 3)
